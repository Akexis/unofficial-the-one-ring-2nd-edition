...
Before installing this system, you should rename any files that have `unofficial-the-one-ring-2nd-edition` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `unofficial-the-one-ring-2nd-edition` and `unofficial-the-one-ring-2nd-edition` and do the same for those, replacing them with appropriate names for your system.
...
![image](http://mattsmith.in/images/unofficial-the-one-ring-2nd-edition.png)
